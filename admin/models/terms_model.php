...
$strSQL = "SELECT * FROM cis282final.terms ORDER BY term_id "; // WHERE u.user_id = $userId
...
$termList = mysqli_fetch_all($result, MYSQLI_ASSOC); // you will rename your variable for each specific query
