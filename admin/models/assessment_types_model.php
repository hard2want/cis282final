...
$strSQL = "SELECT * FROM cis282final.assessment_types ORDER BY assessment_type_id "; // WHERE u.user_id = $userId
...
$assessmentTypeList = mysqli_fetch_all($result, MYSQLI_ASSOC); // you will rename your variable for each specific query
