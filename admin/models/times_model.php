...
$strSQL = "SELECT * FROM cis282final.times ORDER BY time_id "; // WHERE u.user_id = $userId
...
$timeList = mysqli_fetch_all($result, MYSQLI_ASSOC); // you will rename your variable for each specific query
