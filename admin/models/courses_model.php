...
$strSQL = "SELECT * FROM cis282final.courses c ORDER BY c.course_id "; // WHERE u.user_id = $userId
...
$courseList = mysqli_fetch_all($result, MYSQLI_ASSOC); // you will rename your variable for each specific query
